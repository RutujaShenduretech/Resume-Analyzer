...
/>
  ...
  className="rounded-xl px-8 py-3 font-semibold text-gray-50 bg-gradient-to-r from-sky-500 to-blue-600"
>
  Download Resume
</button>
        ...
        <div className="sticky top-8 h-fit">
          <div className="rounded-3xl bg-white shadow-2xl border border-slate-200 p-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-2xl font-bold text-sky-500">AI Assistant</h2>
            </div>

            <div className="mt-6 rounded-2xl bg-sky-50 p-5">
              <h3 className="font-semibold text-sky-400">ATS Score</h3>
              ...
              <p className="mt-2 text-sky-600 font-bold text-xl">82 / 100</p>
            </div>
